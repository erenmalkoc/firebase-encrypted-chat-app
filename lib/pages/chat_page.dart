...
class ChatPageState extends State<ChatPage> {
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      chatProvider.sendMessage(chatProvider.encryptMessage(content), type,
          groupChatId, currentUserId, widget.arguments.peerId);
          ...
          children: <Widget>[
            messageChat.type == TypeMessage.text
                ...
                ? Container(
                    ...
                    child: Text(
                      chatProvider.decryptMessage(messageChat.content),
                      style:
