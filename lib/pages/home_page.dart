...
import 'package:firebase_chat_app/pages/setting_page.dart';
...
class HomePageState extends State<HomePage> {
  ...
  void showNotification(RemoteNotification remoteNotification) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      Platform.isAndroid ? 'com.example.firebase_chat_app' : 'com.example.firebase_chat_app',
      'Flutter chat demo',
      playSound: true,
          ...
          Expanded(
            child: TextFormField(
              ...
              decoration: const InputDecoration.collapsed(
                hintText: 'Search nickname (you have to type exactly)',
